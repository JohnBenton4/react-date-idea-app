  ...
  return (
    <div className="container">
      ...
      <div className="searchFields">
        <br></br>
        <div className="type">
          <h2> What Type Of Date Are You Looking For? </h2>
          <TypeList
            onSetType={setType}
            type={type}
        ...
        <div className="number">
          <h2> How Many People Are Going on This Date? </h2>
          <NumberList
            onSetParticipants={setParticipants}
            participants={participants}
            isDisabled={isParticipantsDisabled}
          />
        </div>
        <div className="price">
      ...
      <br></br>
      <Search
        activity={type.activity || participants.activity || price.activity}
      />
    </div>
  );
}
...
//typelist sends it back up to App.jss and Search receives the info
